...
class mod_iconicrep_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        //-------------------------------------------------------------------------------
        // Choose icon fieldset ( Defines a list of icons to be displayed in checkboxes
        ...
        $mform->addElement('html', '<input type="checkbox" name="choose-icons[]" id="chat" value = "chat">');
        $mform->addElement('html','<label for="chat"> Chat </ label>');
        $mform->addElement('html','</ Li>');
        
        $mform->addElement('html','<li class="choose-icon choice">');
        $mform->addElement('html', '<input type="checkbox" name="choose-icons[]" id="choice" value = "choice">');
        $mform->addElement('html','<label for="choice"> Choice </ label>');
        $mform->addElement('html','</ Li>');
       
        $mform->addElement('html','<li class="choose-icon forum">');
        $mform->addElement('html', '<input type="checkbox" name="choose-icons[]" id="forum" value="forum">');
        ...
        $mform->addElement('html','<input type="checkbox" name="choose-icons[]" id="label" value="label">');
        $mform->addElement('html','<label for="label"> Label </ label>');
        $mform->addElement('html','</ Li>');
    
        $mform->addElement('html','<li class="choose-icon url">');
        $mform->addElement('html','<input type="checkbox" name="choose-icons[]" id="url" value="url">');
        $mform->addElement('html','<label for="url"> URL </ label>');
        $mform->addElement('html','</ Li>');

        $mform->addElement('html','<li class="choose-icon page1">');
        $mform->addElement('html','<input type="checkbox" name="choose-icons[]" id="page1" value="page">');
